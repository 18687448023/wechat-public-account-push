export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx8771a120b2fd851d",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "0ef903d4e0112f3c998f78b4d09e1aba",
  ...
  USERS: [
    {
      ...
      id: "oOQD56Spv4ExBMDi8QLLtf0qE_eY",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "QZq-CNVfXkRzO7zTbszzdG68daOByJ2_bOQzBYmxqqk",
      // 所在省份
      province: "贵州",
      // 所在城市
      city: "贵阳",
